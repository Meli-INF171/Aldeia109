...
<html>
	<head>
		...
		<style type="text/css">
			...
			*{margin:0 auto; padding:0; box-sizing: border-box; font-family: 'Poppins',sans-serif;}
			...
			main {
				background: url("img/CAMISAS/malha.png") no-repeat
				center center;
	...
	<body>
		<header>
			<nav>
				...
				<ul class="nav-list">
					...
					<li><a href="">Linha<br>Camisas</a></li>
		...
		<div class="home-about">
            <div class="columns">
                <div class="col fade-in" style="font-size: 20px; color: #12196b;">
					...
					<b>Linha Camisas</b><br>
                    <p>A camiseta básica é confortável, prática e versátil. Permite 
					personalização com logos, frases, grafismos, nomes e geralmente 
					são feitas com meia malha 100% algodão, malha 100% poliéster ou 
					malha PV (65% poliéster/35 %viscose).</p>
                    <br>
					<p>A camisa polo também é confortável e versátil, pode ser feita 
					em diversos tecidos e receber inúmeras personalizações, o que 
					difere ela da camiseta básica é a imagem que ela apresenta, mostrando 
					mais elegância no meio profissional.</p>
					<br>

                </div>
                <div class="col fade-in">
                    <img style="width: 420px; height: 420px;" src="img/CAMISAS/polomalha.png" alt="" class="slide-in from-right" />
                </div>
		...
		<?php
			$sql = "select * from produtos where tipo = 'CAMISAS'"; //where tipo(acessorio, uniforme...) = nome da linha
