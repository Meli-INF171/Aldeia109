...
<html>
	<head>
		<title>Linha Hospitalar e Estética</title>
	...
	<body>
		...
		<div class="home-about">
            <div class="columns">
                <div class="col fade-in" style="font-size: 20px; color: #12196b;">
					...
					<b>Linha Hospitalar e Estética</b><br>
                    <p>A área médica demanda dos profissionais não apenas atenção e precisão no que fazem, 
					como também higiene e segurança para evitar contaminações. Neste quesito, os uniformes 
					são fundamentais, pois vão além da estética e garantem a proteção do profissional e do 
					paciente.</p>
					</p>Médicos, enfermeiros, dentistas, fisioterapeutas, farmacêuticos, nutricionistas e 
					biomédicos são alguns desses profissionais que já sabem que o uniforme deve fazer parte 
					do seu dia a dia.</p>.
                    <br>

                </div>
                <div class="col fade-in">
                    <img src="img/HOSPITALAR/medico.png" alt="" class="slide-in from-right" />
                </div>
		...
		<?php
			$sql = "select * from produtos where tipo = 'HOSPITALAR'"; //where tipo(acessorio, uniforme...) = nome da linha
