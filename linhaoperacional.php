...
<html>
	<head>
		...
		<style type="text/css">
			...
			*{margin:0 auto; padding:0; box-sizing: border-box; font-family: 'Poppins',sans-serif;}
			...
			main {
				background: url("img/OPERACIONAL/operacional.png") no-repeat
				center center;
	...
	<body>
		...
		<div class="home-about">
            <div class="columns">
                <div class="col fade-in" style="font-size: 20px; color: #12196b;">
					...
					<b>Linha Operacional</b><br>
                    <p>Utilizados na construção civil, em indústria, condomínios e serviços de transporte, 
					os uniformes operacionais cumprem a função de equipamento de Proteção Individual a 
					partir do momento que são essenciais para o trabalhador se proteger contra fogo, quedas 
					ou outros imprevistos que podem colocar sua vida em risco.</p>
                    <br>

                </div>
                <div class="col fade-in">
                    <img src="img/OPERACIONAL/prancheta.png" alt="" class="slide-in from-right" />
                </div>
		...
		<?php
			$sql = "select * from produtos where tipo = 'OPERACIONAL'"; //where tipo(acessorio, uniforme...) = nome da linha
